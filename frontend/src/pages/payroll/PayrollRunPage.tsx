  ...
  const exportCsv = () =>
    downloadCsv(
      ...
      slips.map((s) => [
        ...
        Math.round(num(s.basicSalary)),
        Math.round(num(s.allowances)),
        Math.round(num(s.grossPay)),
        Math.round(num(s.nssf)),
        Math.round(num(s.shif)),
        Math.round(num(s.housingLevy)),
        Math.round(num(s.taxablePay)),
        Math.round(num(s.paye)),
        Math.round(num(s.otherDeductions)),
        Math.round(num(s.totalDeductions)),
        Math.round(num(s.netPay)),
      ]),
    );
